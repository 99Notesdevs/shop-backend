...
class EmailService {
     ...
     */
    static sendVerificationEmail(to, token, name) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param name User's name
     */
    static sendPasswordResetEmail(to, token, name) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    static sendOrderConfirmationEmail(to, orderId, orderItems, totalAmount, name) {
        return __awaiter(this, void 0, void 0, function* () {
