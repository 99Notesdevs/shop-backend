...
class WishlistRepository {
    static getWishlist(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.default.info('Fetching wishlist from repository');
            const wishlist = yield prisma_1.prisma.wishList.findUnique({
                where: { userId },
    ...
    static addItemToWishlist(userId, productId) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.default.info('Adding item to wishlist in repository');
            console.log("here", userId, productId);
            const wishlist = yield prisma_1.prisma.wishList.update({
                where: { userId },
                data: {
                    products: {
    ...
    static removeItemFromWishlist(userId, productId) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.default.info('Removing item from wishlist in repository');
            const wishlist = yield prisma_1.prisma.wishList.update({
                where: { userId },
                data: {
                    products: {
