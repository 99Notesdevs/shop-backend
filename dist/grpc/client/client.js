...
exports.updateUserRating = exports.getUserRating = exports.getAuthToken = void 0;
...
const getAuthToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        authClient.GetAuthToken({ token }, (error, response) => {
            if (error)
                reject(error);
            else
                resolve(response);
...
const getUserRating = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        userClient.GetUserRating({ userId }, (error, response) => {
            if (error)
                reject(error);
            else
                resolve(response);
...
const updateUserRating = (userId, rating) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        userClient.UpdateUserRating({ userId, rating }, (error, response) => {
            if (error)
                reject(error);
            else
                resolve(response);
